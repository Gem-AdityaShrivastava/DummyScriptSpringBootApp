...
import com.gemini.DummyScript.service.BookService;
...
public class BookController {
    ...
    @GetMapping({"/Book/{Id}"})
        public ResponseEntity<com.gemini.DummyScript.model.Book> getBook(@PathVariable Integer Id) {
            com.gemini.DummyScript.model.Book result=objectMapper.convertValue(objectService.getBook(Id), com.gemini.DummyScript.model.Book.class);
            com.gemini.DummyScript.model.Book dummyBody = null;
                if(result!=null){
